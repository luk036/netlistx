...
class TestSolveHadlockMaxCut:
    ...
    def test_square_diagonal(self) -> None:
    ...
    def test_grid_bipartite(self) -> None:
...
class TestValidateMaxCut:
    ...
    def test_invalid_cut(self) -> None:
    ...
    def test_cut_weight_no_attribute(self) -> None:
